...
describe('Integration Test', () => {
    ...
    const createNER = (name, host, port, peers, removeData = true) => {
    ...
    step('start server 1', () => {
        return createNER(name1, 'localhost', 3001, [])
            .then((httpServer) => {
    ...
    step('start server 2', () => {
        return createNER(name2, 'localhost', 3002, [{ url: 'http://localhost:3001' }])
            .then((httpServer) => {
    ...
    describe('Complementary tests', () => {
        ...
        step('restart server 1', () => {
            return Promise.resolve()
                ...
                .then(() => {
                    return createNER(name1, 'localhost', 3001, [], false)
                        .then((httpServer) => {
                            context.httpServer1 = httpServer;
                        });
                });
